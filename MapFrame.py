...
class MapFrameClass:
    ...
    def buildFrame(self, fatherFrame):
        ...
        self.geofence_frame.rowconfigure(2, weight=1)
        ...
        #self.geofence_height_label = tk.Label(self.geofence_frame, text="Altura màxima (m):")
        #self.geofence_height_label.grid(row=2,column=0,padx=5,pady=3,sticky="e")

        #self.geofence_height_entry = tk.Entry(self.geofence_frame)
        #self.geofence_height_entry.grid(row=2,column=1,padx=5,pady=3,sticky="w")

        #self.Buttton_Act_Des_Fence = tk.Button(self.geofence_frame,text="Activar Geo Fence", bg="dark orange", command=self.toggle_geofence)
        #self.Buttton_Act_Des_Fence.grid(row=3,column=0,columnspan=2,padx=5,pady=3,sticky="nesw")
